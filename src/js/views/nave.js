...
const Nave = (props) => {
    ...
    useEffect(async () => {
        const res = await fetch(`${config.HOSTNAME}/starships/${params.uid}`);
          ...
          <div className="card mb-3" style={{width: "700px"}}>
            <div className="row g-0">
                <div className="col-md-4">
                    <img src="https://via.placeholder.com/200/FFFF00/000000" className="img-fluid rounded-start m-1" />
                 </div>
                    <div className="col-md-8">
                        ...
                        <div className="card-footer bg-transparent d-flex row justify-content-center container col ms-1">
                            ...
                            <div className="mt-1 col-2"><h6>Starship class:</h6> <p>{detalle.starship_class}</p></div>
                            <div className="mt-1 col-2"><h6>Manufacturer:</h6> <p>{detalle.properties.manufacturer}</p></div>
                            <div className="mt-1 col-2"><h6>Cost in credits:</h6> <p>{detalle.cost_in_credits}</p></div>
