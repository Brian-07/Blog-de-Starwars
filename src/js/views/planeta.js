          ...
          <div className="card mb-3" style={{width: "700px"}}>
            <div className="row g-0">
                <div className="col-md-4">
                    <img src="https://via.placeholder.com/200/008000/008000" className="img-fluid rounded-start m-1" />
                 </div>
                    <div className="col-md-8">
                        ...
                        <div className="card-footer bg-transparent d-flex row justify-content-center container col ms-1">
                            <div className="mt-1 col-2"><h6>Climate:</h6><p>{detalle.properties.climate}</p></div>
                            <div className="mt-1 col-2"><h6>Terrain:</h6> <p>{detalle.properties.terrain}</p></div>
                            <div className="mt-1 col-2"><h6>Diameter:</h6> <p>{detalle.properties.diameter}</p></div>
                            <div className="mt-1 col-2"><h6>Orbital:</h6> <p>{detalle.properties.orbital_period}</p></div>
                            <div className="mt-1 col-2"><h6>Gravity:</h6> <p>{detalle.properties.gravity}</p></div>
                            <div className="mt-1 col-2"><h6>Rotation:</h6> <p>{detalle.properties.rotation_period}</p></div>
                         </div>
                </div>
            </div>
        </div>
